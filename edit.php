...
<div class="container">
  <form   class="mt-5"  method="POST" action="upadete.php" >

    <label for="fname">اسم المريض</label>
    <input type="text"  name="user" value=<?= $row['name'] ?> >
...
<button onclick="add()" type="submit" class="btn btn-primary"> تعديل</button>
